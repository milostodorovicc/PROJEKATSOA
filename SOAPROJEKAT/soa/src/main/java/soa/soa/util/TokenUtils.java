...
public class TokenUtils {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        Registrovanikorisnik user = (Registrovanikorisnik) userDetails;
...
//                && !isCreatedBeforeLastPasswordReset(created, user.getLozinka())); // nakon kreiranja tokena korisnik nije menjao svoju lozinku
    }
